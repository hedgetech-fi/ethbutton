!function(n) {
	...
	([function(n, t, e) {
		...
		t.a = function (n, t, e) {
			...
			function E() {
				parseFloat(m.value) > 0?x("enabled") && (b.innerHTML = "Donate",
					v = !0):x("disabled") && (b.innerHTML = "Donate",
					v = !1)
			}
